...
4. Run `planning_reviewer` separately before risky implementation when routed. After implementation, run only the routed implementation reviewers, in parallel, with at most four roles.
