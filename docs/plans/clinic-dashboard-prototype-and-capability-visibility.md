...
| ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Dashboard reporting controls and values     | Show only approved reporting values and label fixture-backed series as prototype data. Public profile completeness is composed independently from the clinic-bound profile, gallery, and treatment sources; CSV export remains limited to profile views. | [website#1531](https://github.com/findmydoc-platform/website/issues/1531)                                                                            | Tenant-safe reporting facade defines the remaining approved source-backed metrics. Impressions and booking-derived claims remain unavailable until that contract exists. |
...
| Profile-write and treatment controls        | Remove the temporary demo gate. The authenticated clinic capabilities and source-backed profile, gallery, and treatment contracts determine read and edit access.                                                                                        | [website#1528](https://github.com/findmydoc-platform/website/issues/1528)                                                                            | Fulfilled for the currently supported profile, gallery, and treatment contracts; new fields require their own approved source contract.                                  |
...
| Certificate task details                    | Do not show certificate tasks or actions in Profile Progress.                                                                                                                                                                                            | No approved backend issue                                                                                                                            | An approved certificate capability and completeness criterion exist.                                                                                                     |
