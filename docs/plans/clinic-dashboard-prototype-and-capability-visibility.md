...
| ---------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| Dashboard overview     | [dashboard overview](./assets/clinic-dashboard-prototype/dashboard-overview.png)     | Reporting, clinic preview, profile actions, and certificate-task controls.                        |
...
| Support request flow                        | Hide the support entry point and request dialog.                                               | No approved backend issue                                                                                                                            | An approved support capability exists.                             |
