...
| ---------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Dashboard overview     | [dashboard overview](./assets/clinic-dashboard-prototype/dashboard-overview.png)  | Reporting, clinic preview, profile actions, and later-scope certificate controls.                 |
...
| Patient profile dialog | [patient profile](./assets/clinic-dashboard-prototype/patient-profile-dialog.png) | Purpose-limited inquiry projection (#1526); no inferred medical record.                           |
...
| Certificates, notifications, support, templates, exports, appointments | Hide each selected unsupported group; do not replace it with unrelated data.                   | No approved backend issue                                                                                                                            | A separately approved capability exists.                           |
