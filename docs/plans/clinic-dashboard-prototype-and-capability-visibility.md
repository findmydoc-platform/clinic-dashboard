...
| ---------------------- | ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dashboard overview     | [dashboard overview](./assets/clinic-dashboard-prototype/dashboard-overview.png)     | Reporting with four selectable fixture-backed KPI series, a static profile-completion card, a five-stage conversion process, prototype location summary, a top-aligned lower grid, clinic preview, profile actions, and certificate-task controls. |
...
| Review-management actions                       | Hide response drafts and pending-moderation responses outside the selected walkthrough; continue showing only published responses. Keep response, appeal, and management mutations unavailable.                                                                            | [website#1529](https://github.com/findmydoc-platform/website/issues/1529)                                                                                   | Authorized review management and separate approved-response/moderation contracts exist.                                                                     |
...
Reply templates remain part of the message-workspace gate, while dashboard and review exports remain part of their respective reporting and review-management gates. The Subscriptions placeholder is a local navigation and visibility contract only; it adds no Website Capability Matrix row. The current prototype has no appointment surface, so it emits no appointment capability or placeholder gate.
